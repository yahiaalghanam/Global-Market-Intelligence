/*
=====================================================================================
Query: EUR Daily Time Series with Forward-Fill and Trend Analysis
=====================================================================================
...
=====================================================================================
Description:
This query generates a continuous daily time series for EUR exchange rates against EGP.
...
base AS (
    ...
    OUTER APPLY (
        -- Forward-fill: retrieve latest available EUR record
        SELECT TOP 1 
            g.buy,
            g.Sell,
            g.Currency
